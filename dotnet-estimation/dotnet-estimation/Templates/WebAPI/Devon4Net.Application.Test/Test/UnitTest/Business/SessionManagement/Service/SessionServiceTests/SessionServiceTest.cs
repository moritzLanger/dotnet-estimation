...
namespace Devon4Net.Test.xUnit.Test.UnitTest.Management.Controllers
{
    ...
    {
        //private readonly Mock<ISessionRepository> sessionRepositoryStub = new();
        protected readonly Mock<ILiteDbRepository<Session>> sessionRepositoryStub = new Mock<ILiteDbRepository<Session>>();
        protected readonly Mock<ILiteDbRepository<User>> userRepositoryStub = new Mock<ILiteDbRepository<User>>();
        protected readonly Mock<IJwtHandler> jwtHandler = new Mock <IJwtHandler>();
